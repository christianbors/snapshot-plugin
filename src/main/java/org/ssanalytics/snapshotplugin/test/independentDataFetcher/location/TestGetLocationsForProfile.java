 ...
 * @author chw
 */
public class TestGetLocationsForProfile {

    public static void main(String args[]) throws Exception {

        ConfigurationFileManager.CONFIG_FILE_NAME = "localMongo.json";

        List<ISharedPlace> list = LocationFetcher.getInstance().getDistinctPlacesWhereProfileHasBeenLatestVersion("773956213", "dd");
        ...
        list = LocationFetcher.getInstance().getDistinctPlacesWhereProfileHasBeenLatestVersion("773956213", "dd");
