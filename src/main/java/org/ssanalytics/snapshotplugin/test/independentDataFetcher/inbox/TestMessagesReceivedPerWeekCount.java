 ...
 * @author chw
 */
public class TestMessagesReceivedPerWeekCount {
    ...
    public static void main(String args[]) throws Exception {
        ...
        Map<Date, Integer> map = InboxFetcher.getInstance().getInboxCountPerWeekForSnapshotRootLatestVersion("dd");
        ...
        for (Date dt : map.keySet()) {
            ...
            System.out.println("inbox count:      " + map.get(dt));
            System.out.println("");
        }
        ...
        map = InboxFetcher.getInstance().getInboxCountPerWeekForSnapshotRootLatestVersion("dd");
