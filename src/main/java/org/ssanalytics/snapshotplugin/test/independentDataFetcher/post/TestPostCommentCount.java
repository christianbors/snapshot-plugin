 ...
 * @author chw
 */
public class TestPostCommentCount {
    ...
    public static void main(String args[]) throws Exception {
        ...
        Map<IPost, Integer> map = PostFetcher.getInstance().getPostLikeCountForProfileForSnapshotLatestVersion("dd", "100000458083750");

        System.out.println(map.size());

        for (IPost p : map.keySet()) {

            System.out.println("Post type:          " + p.getType());
            System.out.println("number of comments: " + map.get(p));
            System.out.println("");
        }
        ...
        map = PostFetcher.getInstance().getPostLikeCountForProfileForSnapshotLatestVersion("dd", "100000458083750");
