 ...
 */
package org.ssanalytics.snapshotplugin.test.independentDataFetcher.locationPost;
 ...
 * @author chw
 */
public class TestWhoHasBeenWherePost {
    ...
    public static void main(String args[]) throws Exception {
        ...
        Map<ISharedPlace, List<NamedItem>> map = LocationPostFetcher.getInstance().getWhoHasBeenWhereSnapshotLatestVersion("dd");
        ...
        map = LocationPostFetcher.getInstance().getWhoHasBeenWhereSnapshotLatestVersion("dd");
