 ...
 * @author chw
 */
public class TestGetLocationsAndVisitorsForProfilesForSnapshot {
    ...
    public static void main(String args[]) throws Exception {
        ...
        Map<ISharedPlace, List<NamedItem>> map = LocationFetcher.getInstance().getLocationsAndVisitorsForProfilesForSnapshotLatestVersion("small");
        ...
        map = LocationFetcher.getInstance().getLocationsAndVisitorsForProfilesForSnapshotLatestVersion("Bob");
