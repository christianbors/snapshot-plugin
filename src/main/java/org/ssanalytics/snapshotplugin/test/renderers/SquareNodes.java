 ...
 */
package org.ssanalytics.snapshotplugin.test.renderers;
...
public class SquareNodes implements Renderer {

	public static String ENABLE_SQUARE_NODES = "SquareNodes.property.enable";
    ...
    public PreviewProperty[] getProperties() {
        ...
        PreviewProperty[] props = new PreviewProperty[]{};
        ...
        newProps[newProps.length - 1] = PreviewProperty.createProperty(this, ENABLE_SQUARE_NODES, Boolean.class,
                "Enable Square Nodes",
                "Replace Circle Nodes by Squares",
