 ...
 * @author chw
 */
public class TestWhoLikesTheSameInterestsSql {
    ...
    public static void main(String args[]) throws Exception {
        ...
        Map<ICategorizedDomain, List<NamedItem>> map = DaoFactory.getInterestDAO().getWhoLikesTheSameInterestsAsProfileForSnapshotLatestVersion("dd", "100003541991661");
