 ...
 * @author chw
 */
public class TestGetWhoLikesTheSameMoviesMongo {
    ...
    public static void main(String args[]) throws Exception {
        ...
        Map<ICategorizedDomain, List<NamedItem>> map = DaoFactory.getMovieDAO().getWhoLikesTheSameMoviesAsProfileForSnapshotLatestVersion("dd", "100000947086937");
        ...
        for (ICategorizedDomain icd : map.keySet()) {
            ...
            System.out.println("Movie name: " + icd.getName() + "   count: " + l.size());
        }
    }
