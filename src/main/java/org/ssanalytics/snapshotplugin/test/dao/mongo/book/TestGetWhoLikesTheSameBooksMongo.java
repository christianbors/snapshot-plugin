 ...
 * @author chw
 */
public class TestGetWhoLikesTheSameBooksMongo {
    ...
    public static void main(String args[]) throws Exception {
        ...
        Map<ICategorizedDomain, List<NamedItem>> map = DaoFactory.getBookDAO().getWhoLikesTheSameBooksAsProfileForSnapshotLatestVersion("dd", "100000947086937");
