 ...
 * @author chw
 */
public class TestGetWhoLikesTheSameActivitiesMongo {
    ...
    public static void main(String args[]) throws Exception {
        ...
        Map<ICategorizedDomain, List<NamedItem>> map = DaoFactory.getActivityDAO().getWhoLikesTheSameActivitiesAsProfileForSnapshotLatestVersion("dd", "100000947086937");
        ...
        for (ICategorizedDomain icd : map.keySet()) {
            ...
            System.out.println("Activity name: " + icd.getName() + "   count: " + l.size());
        }
    }
