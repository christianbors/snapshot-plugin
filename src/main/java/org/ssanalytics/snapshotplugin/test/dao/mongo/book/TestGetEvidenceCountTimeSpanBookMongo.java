 ...
 * @author chw
 */
public class TestGetEvidenceCountTimeSpanBookMongo {
    ...
    public static void main(String args[]) throws Exception{
        ...
        Map<CategoryItem, Integer> map = DaoFactory.getBookDAO().getEvidenceCountForSnapshotLatestVersion("dd", oneYearAgo, System.currentTimeMillis());
