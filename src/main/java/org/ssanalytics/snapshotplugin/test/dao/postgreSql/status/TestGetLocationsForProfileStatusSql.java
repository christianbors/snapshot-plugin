 ...
 */
package org.ssanalytics.snapshotplugin.test.dao.postgreSql.status;

import org.ssanalytics.snapshotplugin.test.dao.mongo.status.*;
 ...
 * @author chw
 */
public class TestGetLocationsForProfileStatusSql {
    
        public static void main(String args[]) throws Exception{
        
        ConfigurationFileManager.CONFIG_FILE_NAME = "localPostgre.json";
        
        List<ISharedPlace> list = DaoFactory.getStatusDAO().getLocationsForProfileSnapshotLatestVersion("773956213", "dd");
