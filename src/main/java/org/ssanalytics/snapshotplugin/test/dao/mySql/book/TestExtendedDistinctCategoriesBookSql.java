 ...
 */
package org.ssanalytics.snapshotplugin.test.dao.mySql.book;

import org.ssanalytics.snapshotplugin.test.dao.postgreSql.book.*;
 ...
 * @author chw
 */
public class TestExtendedDistinctCategoriesBookSql {
    
    public static void main(String args[]) throws Exception{
        
        ConfigurationFileManager.CONFIG_FILE_NAME = "localMySQL.json";
        
        Map<String, Integer> map = DaoFactory.getBookDAO().getExtendedDistinctBookCategories();
