 ...
 * @author chw
 */
public class TestGetLocationsForProfilePhotoMongo {
    
        public static void main(String args[]) throws Exception{
        
        ConfigurationFileManager.CONFIG_FILE_NAME = "localMongo.json";
        
        List<ISharedPlace> list = DaoFactory.getPhotoDAO().getLocationsForProfileSnapshotLatestVersion("773956213", "dd");
