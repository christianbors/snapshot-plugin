 ...
 * @author christian
 */
public class GeneralGeneratorComboBoxModel implements ComboBoxModel<ComboItemGenerator> {
    ...
    public GeneralGeneratorComboBoxModel() {
        if(genController != null) {
            for (Generator gen : Lookup.getDefault().lookupAll(GeneralGenerator.class)) {
//                if(GeneratorWhitelist.allGenerators.contains(gen.getName())) {
