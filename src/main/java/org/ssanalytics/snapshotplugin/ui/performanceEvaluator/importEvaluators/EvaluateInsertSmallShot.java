 ...
 * @author chw
 */
public class EvaluateInsertSmallShot {
    ...
    public static void main(String args[]) throws Exception{
        ...
        inserter.insertFromFile(new File("D:/git/ssanalytics/testdata/evalshot_small.json"), "EVAL_SMALL", System.currentTimeMillis());
