...
public class EvaluateGetCommentCount {
    ...
    // change to only test the smallest snapshot for PostgreSQL
    ...
    public static void main(String args[]) throws Exception{
        ...
        Map<NamedItem, Integer> map = CommentsFetcher.getInstance().getCommentCountForEveryProfileInSnapshotLatestVersion("EVAL_LARGE");
        ...
        map = CommentsFetcher.getInstance().getCommentCountForEveryProfileInSnapshotLatestVersion("EVAL_MEDIUM");
        ...
        map = CommentsFetcher.getInstance().getCommentCountForEveryProfileInSnapshotLatestVersion("EVAL_SMALL");
        ...
        map = CommentsFetcher.getInstance().getCommentCountForEveryProfileInSnapshotLatestVersion("EVAL_LARGE");
