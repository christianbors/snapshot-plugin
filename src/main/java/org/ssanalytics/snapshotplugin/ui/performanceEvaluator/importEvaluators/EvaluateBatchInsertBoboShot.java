 ...
 * @author chw
 */
public class EvaluateBatchInsertBoboShot {
    ...
    public static void main(String args[]) throws SQLException, ParseException, IOException{        
        ...
        inserter.insertFromFile(new File("D:/git/ssanalytics/testdata/snapshot1347005381.json"), "PHOTOTEST", System.currentTimeMillis());
