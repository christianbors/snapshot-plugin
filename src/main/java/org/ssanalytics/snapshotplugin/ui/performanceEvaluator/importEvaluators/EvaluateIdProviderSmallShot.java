 ...
 * @author chw
 */
public class EvaluateIdProviderSmallShot {
    ...
    public static void main(String args[]) throws SQLException, ParseException, IOException{        
        ...
        inserter.insertFromFile(new File("D:/git/ssanalytics/testdata/socialsnapshot1336659346.json"), "ID_TEST", System.currentTimeMillis());
