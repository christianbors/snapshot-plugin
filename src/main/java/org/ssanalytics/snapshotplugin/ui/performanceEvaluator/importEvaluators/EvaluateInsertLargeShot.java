 ...
 * @author chw
 */
public class EvaluateInsertLargeShot {
    ...
    public static void main(String args[]) throws Exception{
        ...
        inserter.insertFromFile(new File("D:/git/ssanalytics/testdata/evalshot_large.json"), "EVAL_LARGE", System.currentTimeMillis());
