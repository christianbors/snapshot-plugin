...
public class EvaluateGetMutualFriendsCount {
    ...
    public static void main(String args[]) throws Exception{
        ...
        float f = FriendFetcher.getInstance().getAverageNumberOfMutualFriendsForSnapshotLatestVersion("EVAL_LARGE");
        time_mongo_large += System.currentTimeMillis();
        System.out.println("Finished fetching comments from MongoDB/LARGE!");
        System.out.println("Fetched " + f + " elements in " + time_mongo_large + " ms");
        
        //medium shot
        long time_mongo_medium = 0 - System.currentTimeMillis();
        f = FriendFetcher.getInstance().getAverageNumberOfMutualFriendsForSnapshotLatestVersion("EVAL_MEDIUM");
        time_mongo_medium += System.currentTimeMillis();
        System.out.println("Finished fetching comments from MongoDB/MEDIUM!");
        System.out.println("Fetched " + f + " elements in " + time_mongo_medium + " ms");
        
        //small shot
        long time_mongo_small = 0 - System.currentTimeMillis();
        f = FriendFetcher.getInstance().getAverageNumberOfMutualFriendsForSnapshotLatestVersion("EVAL_SMALL");
        time_mongo_small += System.currentTimeMillis();
        System.out.println("Finished fetching comments from MongoDB/SMALL!");
        System.out.println("Fetched " + f + " elements in " + time_mongo_small + " ms");
        ...
        f = FriendFetcher.getInstance().getAverageNumberOfMutualFriendsForSnapshotLatestVersion("EVAL_LARGE");
        time_postgre_large += System.currentTimeMillis();
        System.out.println("Finished fetching comments from PostgreSQL/LARGE!");
        System.out.println("Fetched " + f + " elements in " + time_postgre_large + " ms");
        ...
        System.out.println("Fetched " + f + " elements in " + time_postgre_medium + " ms");
        
        //small shot
        long time_postgre_small = 0 - System.currentTimeMillis();
        f = FriendFetcher.getInstance().getAverageNumberOfMutualFriendsForSnapshotLatestVersion("EVAL_SMALL");
        time_postgre_small += System.currentTimeMillis();
        System.out.println("Finished fetching comments from PostgreSQL/SMALL!");
        System.out.println("Fetched " + f + " elements in " + time_postgre_small + " ms");
        ...
        //System.out.println("Fetched " + f + " elements in " + time_mysql_small + " ms");
        ...
        //System.out.println("Fetched " + f + " elements in " + time_mysql_medium + " ms");
        ...
        //System.out.println("Fetched " + f + " elements in " + time_mysql_large + " ms");        
        
        System.out.println("----------------------------------------");
        System.out.println("| EVALUATION: GET ALL COMMENTS         |");
        System.out.println("|--------------------------------------|");
