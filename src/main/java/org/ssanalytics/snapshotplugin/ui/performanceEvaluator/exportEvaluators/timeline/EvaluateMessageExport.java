 ...
 * @author chw
 */
public class EvaluateMessageExport {
    ...
    public static void main(String args[]) throws Exception{
        ...
        TimeflowMessageExporter.getInstance().exportMessageTimelineForRootAccountOfSnapshotLatestVersion("TimelineEventSmallMongo.timeline", "EVAL_LARGE");
        time_mongo_large += System.currentTimeMillis();
        System.out.println("Finished exporting event timeline from MongoDB/LARGE!");
        System.out.println("Time taken: " + time_mongo_large + " ms");
        
        
        //medium shot
        long time_mongo_medium = 0 - System.currentTimeMillis();
        TimeflowMessageExporter.getInstance().exportMessageTimelineForRootAccountOfSnapshotLatestVersion("TimelineEventMediumMongo.timeline", "EVAL_MEDIUM");
        ...
        TimeflowMessageExporter.getInstance().exportMessageTimelineForRootAccountOfSnapshotLatestVersion("TimelineEventSmallMongo.timeline", "EVAL_SMALL");
        ...
        TimeflowMessageExporter.getInstance().exportMessageTimelineForRootAccountOfSnapshotLatestVersion("TimelineEventLargePostgre.timeline", "EVAL_LARGE");
        time_postgre_large += System.currentTimeMillis();
        System.out.println("Finished exporting event timeline from PostgreSQL/LARGE!");
        System.out.println("Time taken: " + time_postgre_large + " ms");
        
        //medium shot
        long time_postgre_medium = 0 - System.currentTimeMillis();
        TimeflowMessageExporter.getInstance().exportMessageTimelineForRootAccountOfSnapshotLatestVersion("TimelineEventMediumPostgre.timeline", "EVAL_MEDIUM");
        ...
        TimeflowMessageExporter.getInstance().exportMessageTimelineForRootAccountOfSnapshotLatestVersion("TimelineEventSmallPostgre.timeline", "EVAL_SMALL");
